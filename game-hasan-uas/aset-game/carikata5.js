  ...
  !function () {
    ...
    function e(e, t) {
      ...
      var u = {
        ...
        gridSize: 10,
        words: ["Arithmetic", "Assignment", "Comparison", "Logical", "Ternary", "Bitwise"],
        wordsList: [],
        debug: false,
      };
    ...
    e.prototype.parseWords = function (e) {
      ...
      e.prototype.gameOver = function () {
        ...
        e.innerHTML =
          "<div class='ws-game-over-inner' id='ws-game-over-inner'><div class='ws-game-over' id='ws-game-over'><h2>Game Finishh!</h2><p>Selamat anda telah menyelesaikan semua level!</p></div></div>";
